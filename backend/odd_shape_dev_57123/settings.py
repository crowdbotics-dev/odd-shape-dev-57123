"""
Django settings for odd_shape_dev_57123 project.
...
ROOT_URLCONF = 'odd_shape_dev_57123.urls'
...
WSGI_APPLICATION = 'odd_shape_dev_57123.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_shape_dev_57123 API",
    "DESCRIPTION": "API documentation for odd_shape_dev_57123 App",
    "VERSION": "v1",
}
